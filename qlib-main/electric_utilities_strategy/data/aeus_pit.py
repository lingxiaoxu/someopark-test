"""
AEUS point-in-time (PIT) + JSON storage helpers
===============================================
Shared utilities for the AEUS data layer.  The single most dangerous source of
...
Storage convention (all under price_data/elec_strategy/{industry,company}/)
--------------------------------------------------------------------------
...
# Project root: data -> electric_utilities_strategy -> qlib-main -> someopark-test
_PROJECT_DIR = Path(__file__).resolve().parents[3]
SEMI_DATA_DIR = _PROJECT_DIR / "price_data" / "elec_strategy"
...
#     RESULT: OK
# 一次都没报警。根因是没人调 `aeus_pipeline.sh update_data`,但**真正致命
