...
def _run_single(
    ...
    from electric_utilities_strategy.backtest.costs import estimate_annual_costs
...
if __name__ == "__main__":
    ...
    cache_dir = Path(cfg.get("data", {}).get("cache_dir", "electric_utilities_strategy/data/cache"))
