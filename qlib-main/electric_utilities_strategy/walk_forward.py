"""
walk_forward.py — Walk-Forward IS/OOS Framework for AEUS
====================================================================
...
Usage
-----
    from electric_utilities_strategy.walk_forward import WalkForwardAnalyzer
...
class WalkForwardAnalyzer:
    """
    Walk-forward IS/OOS framework for 59 AEUS param sets.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Walk-Forward IS/OOS analysis for AEUS"
    )
    ...
    if args.mode == "both":
        ...
        if args.output_dir:
            ...
            try:
                from electric_utilities_strategy.portfolio_record import export_wf_diagnostic_excel
