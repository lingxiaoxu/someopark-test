...
Usage:
  conda run -n qlib_run --no-capture-output python \\
      qlib-main/electric_utilities_strategy/weekly_review.py [--top-n 10]
"""
...
def run_weekly_review(
    ...
    try:
        from electric_utilities_strategy.multi_horizon_backtest import run_multi_horizon
    ...
    sl_report = {}
    try:
        inv_path = _THIS_DIR / "inventory_aeus.json"
