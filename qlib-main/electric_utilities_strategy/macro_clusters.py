...
用法(qlib_run 环境):
    python -m electric_utilities_strategy.macro_clusters            # 读 wf_fold_detail.json 重建
    python -m electric_utilities_strategy.macro_clusters --dry-run  # 只训练+聚类,不落盘
"""
...
log = logging.getLogger("electric_utilities_strategy.macro_clusters")
...
def main() -> int:
    ...
    ap = argparse.ArgumentParser(description="AEUS macro cluster rebuild (真修 B)")
