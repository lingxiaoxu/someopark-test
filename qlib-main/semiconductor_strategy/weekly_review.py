...
Usage:
  conda run -n qlib_run --no-capture-output python \\
      qlib-main/semiconductor_strategy/weekly_review.py [--top-n 10]
"""
...
def run_weekly_review(
    ...
    try:
        from semiconductor_strategy.multi_horizon_backtest import run_multi_horizon
    ...
    sl_report = {}
    try:
        inv_path = _THIS_DIR / "inventory_aiss.json"
