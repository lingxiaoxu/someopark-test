...
Risk Management
===============
Position-level and portfolio-level risk controls for the AISS strategy.
...
def vol_scaling_factor(
    ...
    target_vol: float = 0.30,       # AISS default (SSRS 0.12)
...
def apply_risk_controls(
    ...
    # Thresholds
    vol_target: float = 0.30,      # AISS default (SSRS 0.12) — high-beta semis satellite
