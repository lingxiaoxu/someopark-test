...
用法（在 someopark-test/ 目录下）：
    ...
    python qlib-main/semiconductor_strategy/backtest/trade_audit.py
"""
...
# ── 2. Save to Excel ──────────────────────────────────────────────────────────
out_path = os.path.join(REPO_ROOT, "historical_runs", "semiconductor_strategy", "trade_audit.xlsx")
