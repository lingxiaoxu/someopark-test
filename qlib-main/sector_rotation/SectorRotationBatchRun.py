...
logging.getLogger("sector_rotation.backtest.engine").setLevel(logging.WARNING)
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "sector_rotation/; also skip Excel exports that hard-write "
            "historical_runs/. Use for test runs."
        ),
    )
    parser.add_argument(
