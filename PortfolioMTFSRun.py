...
from pair_universe import mtfs_pairs as _mtfs_pairs
DEFAULT_PAIRS = [[s1, s2] for s1, s2 in _mtfs_pairs()]
    ...
    if data_source == 'polygon':
        try:
            ...
            try:
                ...
                log.warning(f"[DataLoader/MTFS] split-cliff heal skipped (non-fatal): {_he}")
            data = check_data_structure(data)
            return data
        except Exception as e:
