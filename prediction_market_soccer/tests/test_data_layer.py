...
from prediction_market_soccer.config import SoccerConfig
from prediction_market_soccer.ingest import store
from prediction_market_soccer.ingest.api_football import ApiFootball, BudgetExceededError
from prediction_market_soccer.ingest.soccer_ingest import _event_rows, _fixture_row
...
def test_store_detailed_roundtrip(conn):
    from prediction_market_soccer.ingest.soccer_ingest import _store_detailed
...
def test_prediction_percent_parse_and_store_tables(conn):
    from prediction_market_soccer.ingest.soccer_ingest import _pct
    assert _pct("45%") == 0.45
    assert _pct("100%") == 1.0
...
def test_monitor_levels_and_runs(conn):
    from prediction_market_soccer.ops.monitor import _level, _age_hours, health_report
