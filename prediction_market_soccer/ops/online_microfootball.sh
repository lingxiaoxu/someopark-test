...
#
# 用法:
#   prediction_market_soccer/ops/online_microfootball.sh            # 完整流程
#   prediction_market_soccer/ops/online_microfootball.sh --check    # 只做预检+现状核对,不执行
#   prediction_market_soccer/ops/online_microfootball.sh --skip-deploy   # 跑完不部署
#   prediction_market_soccer/ops/online_microfootball.sh --skip-dfm      # 只同步资产,不跑 DFM
# ═══════════════════════════════════════════════════════════════════════════════
set -euo pipefail
