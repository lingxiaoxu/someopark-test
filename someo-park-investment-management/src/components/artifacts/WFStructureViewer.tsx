...
const mrptParams = "aggressive, aggressive_vol_release, balanced_plus, conservative, conservative_no_leverage, deep_dislocation, deep_entry_quick_exit, default, fast_reentry, fast_signal, fast_signal_tight_stop, flash_hold, high_entry, high_leverage, high_turnover, high_vol_specialist, long_z_short_v, low_entry, low_vol_specialist, medium_signal_high_leverage, no_leverage, patient_hold, quick_exit, short_z_long_v, slow_reentry, slow_signal, stable_signal_quick_exit, static_threshold, symmetric_exit, tight_stop, vol_adaptive, vol_agnostic, vol_gated, vol_release, vol_release_deep";

const mtfsParams = "aggressive, balanced, beta_neutral, beta_neutral_long_term, conservative, crash_defensive, crash_tolerant, default, entry_filter_kalman, entry_threshold_strong, fast_rebalance, fast_strict, kalman_aggressive, kalman_hedge, let_profits_run, long_term_kalman, long_term_tilt, monthly_aligned_windows, no_reversal_protection, no_skip_month, raw_momentum, raw_momentum_kalman, sensitive_reversal, short_term_beta_neutral, short_term_tilt, slow_rebalance, trend_leverage, uniform_weights, vol_sized_conservative, vol_weighted_sizing, weekly_aligned_windows, monthly_aligned_windows_fc, short_term_beta_neutral_fc, fast_strict_fc, monthly_aligned_windows_fc_skip, crash_adaptive, crash_shortguard, crash_fastwin";
