...
from prediction_market.model.inplay import RED_CARD_LAMBDA_MULT, live_match_prob
...
def live_advance_prob(
    ...
    *,
    ...
    # period == "reg": regulation 3-way (reuse live_match_prob), then layer ET+pens on the draw.
