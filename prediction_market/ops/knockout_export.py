...
machinery here is unchanged.
    ...
    python -m prediction_market.ops.knockout_export → data/output/knockout_bracket.json
"""
...
def _strength(conn, prior):
    ...
    from prediction_market.model.strength import build_strength, update_strength_from_store
